                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#pending" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down">Pending works(<?php echo $pencount ?>)</span></a> </li>

                                    <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#progress" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down">Works in progress(<?php echo $procount ?>)</span></a> </li>
                                    <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#reassign" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down">Rejected works(<?php echo $rejcount ?>)</span></a> </li>
                                    <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#completed" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down">Completed works(<?php echo $comcount ?>)</span></a> </li>
                                                            ...
                                                            while ($row = mysqli_fetch_array($result1)) {
                                                                ...
                                                                switch ($row['status']) {
                                                                    case 1:
                                                                        ...
                                                                        break;
                                                                    case 2:
                                                                        $statusMessage = 'Forwarded to HOD';
                                                                        break;
                                                                    case 3:
